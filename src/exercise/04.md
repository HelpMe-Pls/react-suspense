...
## What I've learnt
- Create a [simple cache](https://epicreact.dev/modules/react-suspense/cache-resources-solution).
- [Implement](https://github.com/HelpMe-Pls/react-suspense/blob/master/src/final/04.extra-2.js) caching with `context` ([at 2:25](https://epicreact.dev/modules/react-suspense/cache-resources-extra-credit-solution-2)). 
- [Implement](https://github.com/HelpMe-Pls/react-suspense/blob/master/src/final/04.extra-3.js) cache invalidation to re-fetch stale data.
## Background
