...
## What I've learnt
- Use `Suspense` in conjunction with `ErrorBoundary` ([at 2:00](https://github.com/HelpMe-Pls/react-suspense/blob/master/src/final/01.extra-1.js)) to handle runtime errors as well as errors while fetching data. 
- SoC by separate the data fetching logics [into a handler](https://github.com/HelpMe-Pls/react-suspense/blob/master/src/final/01.extra-2.js) 
