...
## What I've learnt
- Give the user is a more [predictable](https://github.com/HelpMe-Pls/react-suspense/blob/master/src/final/07.js) loading experience, even if it means that they see the data displayed out of order from how it was loaded.
