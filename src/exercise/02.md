...
## What I've learnt
- The positioning of `ErrorBoundary` and `Suspense` has a significant implications on the [user's experience](https://epicreact.dev/modules/react-suspense/render-as-you-fetch-extra-credit-solution-1).
