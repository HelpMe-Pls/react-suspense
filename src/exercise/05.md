...
## What I've learnt
1. Make an `<Img/>` component that suspends [until](https://github.com/HelpMe-Pls/react-suspense/blob/master/src/final/05.js) the browser has actually loaded the image.
2. Make a request for the image [alongside](https://github.com/HelpMe-Pls/react-suspense/blob/master/src/final/05.extra-1.js) the data, then utilizing the benefits of "[render as you fetch](https://github.com/HelpMe-Pls/react-suspense/blob/master/src/final/05.extra-2.js)".
