...
## What I've learnt
- How `useTransition` works with `Suspense` ([at 2:30](https://epicreact.dev/modules/react-suspense/usetransition-solution)).
- Deprecated: [enhancing overall UX](https://epicreact.dev/modules/react-suspense/usetransition-extra-credit-solution-2) (for a variety of network speed of the user) by adding more options to the `useTransition` hook.
