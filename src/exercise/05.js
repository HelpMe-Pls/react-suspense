...
// <img src={imgSrcResource} {...props} />
function Img({src, alt, ...props}) {
	let imgSrc = imgSrcCache[src]
	if (!imgSrc) {
		imgSrc = createResource(preloadImage(src))
		imgSrcCache[src] = imgSrc
	}
	return <img src={imgSrc.read()} alt={alt} {...props} />
}
