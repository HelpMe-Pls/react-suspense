...
// This gets handled on the browser
...
// serve the cached image (from the browser) to next renders so that they load faster after the initial render
...
function Img({src, alt, ...props}) {
	...
	// Suspense the image until it is preloaded on the browser
